...
A panel data approach will be used to assess the determinants of green investments in EU countries. This cross-country analysis will take into account historical data from Bloomberg, Eurostat and World Bank databases covering the period 2010-2015. The model is estimated in real terms using fixed effects methodology. The impact on green investment is calculated on the basis of covarities exposed in the previous section and takes into account country specific fixed effects. 
