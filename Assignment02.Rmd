...
(((((Include the results of previous studies)))))))

Now we aim to apply a similar methodology to verify the determinants of green investments in EU countries. 

According to @carley2009state mentioned in @romano2011investments (((Include the literature method in which the variable on electricity production was used.)))
